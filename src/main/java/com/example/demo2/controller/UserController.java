...
public class UserController {
    ...
    public String insert(HttpServletRequest request, User u) {
        ...
        boolean isNameExisted = userService.isNameExisted(u.getUsername());
        if (isNameExisted)
            return ReturnMsg.msg(HttpServletResponse.SC_BAD_REQUEST, "添加失败");
    ...
    public String update(HttpServletRequest request, User user) {
        ...
        if (isUpdated) {
            ...
            return ReturnMsg.msg(HttpServletResponse.SC_BAD_REQUEST, "更新失败");
        }
    }
}
