...
public class UserRating {
     ...
     * 行为习惯来反映用户的“评分”，比如一个用户常常收听某一首歌，那么我们可以推断该用户喜欢该戏曲的可能性很大.
    ...
    public static Map<Integer, float[]> getFrequencyMatrix(List<Integer> userIdList, final List<Integer> songIdList,
                                                           List<DownloadRecord> downloadList, List<PlayRecord> playList, List<Like> collectionList) {
     ...
     * （1）为每首戏曲计数songId,CountSet；
     * （2）存放出现过的戏曲songSetFlay,SongIdSet：
     */
